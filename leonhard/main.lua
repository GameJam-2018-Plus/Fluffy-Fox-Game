...
function love.update ( dt )
    ...
    function love.mousepressed( x, y)   
        if x > 371 and x < 571 and y > 600 and y < 700 then 
            love.event.quit()
        end
    end
end
...
function love.draw()
    ...
    love.graphics.draw(animation.spriteSheet, animation.quads[spriteNum], 171)
	--gui sketch
	love.graphics.rectangle("line", 171, 0, 1024, 768)
	love.graphics.rectangle("line", 371, 600, 300, 100)
end	
